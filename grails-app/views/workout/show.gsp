	...
	<body>
		...
		<div id="show-workout" class="content scaffold-show" role="main">
			...
			<ol class="property-list workout">
				...
				<li class="fieldcontain">
					<span id="bikeRides-label" class="property-label"><g:message code="workout.bikeRides.label" default="Bike Rides" /></span>
					
						<g:each in="${workoutInstance.bikeRides}" var="b">
						<span class="property-value" aria-labelledby="bikeRides-label"><g:link controller="bikeRide" action="show" id="${b.id}">${b?.name.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="jogs-label" class="property-label"><g:message code="workout.jogs.label" default="Jogs" /></span>
					
						<g:each in="${workoutInstance.jogs}" var="j">
						<span class="property-value" aria-labelledby="jogs-label"><g:link controller="jog" action="show" id="${j.id}">${j?.name.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="sitUps-label" class="property-label"><g:message code="workout.sitUps.label" default="Sit Ups" /></span>
					
						<g:each in="${workoutInstance.sitUps}" var="s">
						<span class="property-value" aria-labelledby="sitUps-label"><g:link controller="sitUp" action="show" id="${s.id}">${s?.name.encodeAsHTML()}</g:link></span>
						</g:each>
			...
			<g:form url="[resource:workoutInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${workoutInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
