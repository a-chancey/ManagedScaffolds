...
<body>
<a href="#list-workout" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
        ...
        <g:each in="${workoutInstanceList}" status="i" var="workoutInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${workoutInstance.id}">${fieldValue(bean: workoutInstance, field: "name")}</g:link></td>
